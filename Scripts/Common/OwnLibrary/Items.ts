...
function createTrackingOrder(index: number, number: string, shipper: JQuery, isProspect: boolean, incoterm: JQuery, warehouse: string, dateWarehouse: string, trackingId: number, id?: number): any {
    const trackingOrder = {};
